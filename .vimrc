...
if filereadable(expand(vimrc_plugs_local_path))
   exec 'source ' . fnameescape(vimrc_plugs_local_path)
endif
call plug#end()

if filereadable(expand(vimrc_plugs_path))
...
" DISABLE,<C-l> <C-h> <C-j> <C-k> map to move on windows
